MERCHANT_ACCOUNT = '0x076EDD82193Ce262442e92fa4e31eBb61ED1485e'
$.get('/menu',
...
function addComment() {
    ...
    var gaz = document.getElementById("textarea_field_pseudonim").value;
	//tutaj postem w endpoint
    ...
    $.ajax({
        ...
        url: '/addComment',
        dataType: 'json',
        data: JSON.stringify({ "message": message,"pseudonim":pseudonim,"gas":gaz }),
        //data: JSON.stringify({ "name": title }),
        success: function (result) {
        },
        error: function (error) { }
...
function detectMetamask() {
    console.log("some people stand in the darkness")
...
$('.btn-buy').click(function() {
    ...
    const transactionParameters = {
          ...
          gasPrice: '0x01184e72a000', // customizable by user during MetaMask confirmation.
